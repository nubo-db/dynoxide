...
Results from `ubuntu-latest` (<!-- prose:ci_runner_hardware -->4-core AMD EPYC 9V74, 16GB RAM<!-- /bench -->). Commit <!-- bench:ci_commit_link_benchmarks -->[`54a2cb6`](../../../commit/54a2cb6ae8b34dc42db22eefd77681ef4ff8dc7e)<!-- /bench -->. Absolute wall-clock numbers vary between runners; ratios are stable across runs.

### Cold Startup

| Target | Mean | Stddev | vs DynamoDB Local |
|--------|------|--------|-------------------|
| Dynoxide Embedded | <!-- bench:ci_startup_embedded_mean -->0.3ms<!-- /bench --> | <!-- bench:ci_startup_embedded_stddev -->±0.2ms<!-- /bench --> | <!-- bench:ci_startup_embedded_ratio -->**~10,222x faster**<!-- /bench --> |
| Dynoxide HTTP | <!-- bench:ci_startup_http_mean -->2.2ms<!-- /bench --> | <!-- bench:ci_startup_http_stddev -->±2.7ms<!-- /bench --> | <!-- bench:ci_startup_http_ratio -->**~1,277x faster**<!-- /bench --> |
| DynamoDB Local | <!-- bench:ci_startup_ddb_local_mean -->2,833ms<!-- /bench --> | <!-- bench:ci_startup_ddb_local_stddev -->±371ms<!-- /bench --> | — |
| LocalStack | <!-- bench:ci_startup_localstack_mean -->11,848ms<!-- /bench --> | <!-- bench:ci_startup_localstack_stddev -->±955ms<!-- /bench --> | <!-- bench:ci_startup_localstack_ratio -->4.2x slower<!-- /bench --> |
...
| Operation | Dynoxide HTTP (p50) | DynamoDB Local (p50) | Speedup |
|-----------|-------------------|---------------------|---------|
| CreateTable | <!-- bench:ci_op_CreateTable_http -->0.65ms<!-- /bench --> | <!-- bench:ci_op_CreateTable_ddb -->23.0ms<!-- /bench --> | <!-- bench:ci_op_CreateTable_ratio -->**36x**<!-- /bench --> |
| GetItem | <!-- bench:ci_op_GetItem_http -->0.31ms<!-- /bench --> | <!-- bench:ci_op_GetItem_ddb -->0.83ms<!-- /bench --> | <!-- bench:ci_op_GetItem_ratio -->**2.7x**<!-- /bench --> |
| PutItem | <!-- bench:ci_op_PutItem_http -->0.38ms<!-- /bench --> | <!-- bench:ci_op_PutItem_ddb -->0.87ms<!-- /bench --> | <!-- bench:ci_op_PutItem_ratio -->**2.3x**<!-- /bench --> |
| Query (base) | <!-- bench:ci_op_Query_http -->0.30ms<!-- /bench --> | <!-- bench:ci_op_Query_ddb -->1.4ms<!-- /bench --> | <!-- bench:ci_op_Query_ratio -->**4.6x**<!-- /bench --> |
| Query (GSI) | <!-- bench:ci_op_QueryGSI_http -->0.32ms<!-- /bench --> | <!-- bench:ci_op_QueryGSI_ddb -->1.2ms<!-- /bench --> | <!-- bench:ci_op_QueryGSI_ratio -->**3.7x**<!-- /bench --> |
| Query (paginated) | <!-- bench:ci_op_QueryPaginated_http -->2.8ms<!-- /bench --> | <!-- bench:ci_op_QueryPaginated_ddb -->6.2ms<!-- /bench --> | <!-- bench:ci_op_QueryPaginated_ratio -->**2.2x**<!-- /bench --> |
| Scan (full table) | <!-- bench:ci_op_Scan_http -->75.4ms<!-- /bench --> | <!-- bench:ci_op_Scan_ddb -->227.6ms<!-- /bench --> | <!-- bench:ci_op_Scan_ratio -->**3.0x**<!-- /bench --> |
| UpdateItem | <!-- bench:ci_op_UpdateItem_http -->0.39ms<!-- /bench --> | <!-- bench:ci_op_UpdateItem_ddb -->1.4ms<!-- /bench --> | <!-- bench:ci_op_UpdateItem_ratio -->**3.6x**<!-- /bench --> |
| TransactWriteItems | <!-- bench:ci_op_TransactWriteItems_http -->0.68ms<!-- /bench --> | <!-- bench:ci_op_TransactWriteItems_ddb -->4.2ms<!-- /bench --> | <!-- bench:ci_op_TransactWriteItems_ratio -->**6.2x**<!-- /bench --> |
| BatchGetItem (100 keys) | <!-- bench:ci_op_BatchGetItem_http -->3.0ms<!-- /bench --> | <!-- bench:ci_op_BatchGetItem_ddb -->9.8ms<!-- /bench --> | <!-- bench:ci_op_BatchGetItem_ratio -->**3.2x**<!-- /bench --> |
| BatchWriteItem (25 items) | <!-- bench:ci_op_BatchWriteItem_http -->2.1ms<!-- /bench --> | <!-- bench:ci_op_BatchWriteItem_ddb -->8.2ms<!-- /bench --> | <!-- bench:ci_op_BatchWriteItem_ratio -->**3.8x**<!-- /bench --> |
| DeleteItem | <!-- bench:ci_op_DeleteItem_http -->0.34ms<!-- /bench --> | <!-- bench:ci_op_DeleteItem_ddb -->0.86ms<!-- /bench --> | <!-- bench:ci_op_DeleteItem_ratio -->**2.5x**<!-- /bench --> |
| **Total workload** | <!-- bench:ci_workload_http -->**2.8s**<!-- /bench --> | <!-- bench:ci_workload_ddb -->**10.5s**<!-- /bench --> | <!-- bench:ci_workload_ratio -->**3.8x**<!-- /bench --> |
...
| Mode | Wall Clock | Speedup vs DDB Local |
|------|-----------|---------------------|
| Dynoxide Embedded (sequential) | <!-- bench:ci_suite_embedded_seq -->802ms<!-- /bench --> | <!-- bench:ci_suite_embedded_seq_ratio -->**2.9x**<!-- /bench --> |
| Dynoxide Embedded (4x parallel) | <!-- bench:ci_suite_embedded_par -->375ms<!-- /bench --> | <!-- bench:ci_suite_embedded_par_ratio -->**4.8x**<!-- /bench --> |
| Dynoxide HTTP (sequential) | <!-- bench:ci_suite_http_seq -->755ms<!-- /bench --> | <!-- bench:ci_suite_http_seq_ratio -->**3.1x**<!-- /bench --> |
| Dynoxide HTTP (4x parallel) | <!-- bench:ci_suite_http_par -->507ms<!-- /bench --> | <!-- bench:ci_suite_http_par_ratio -->**3.6x**<!-- /bench --> |
| DynamoDB Local (sequential) | <!-- bench:ci_suite_ddb_seq -->2,310ms<!-- /bench --> | — |
| DynamoDB Local (4x parallel) | <!-- bench:ci_suite_ddb_par -->1,818ms<!-- /bench --> | — |

DynamoDB Local barely benefits from parallelism (<!-- bench:ci_suite_ddb_seq_prose -->2,310ms<!-- /bench --> → <!-- bench:ci_suite_ddb_par_prose -->1,818ms<!-- /bench -->). Under concurrent load, individual tests take 3-4x longer due to JVM contention — setup times spike to 200-1,000ms on some tests as `CreateTable` calls queue behind the JVM's single-threaded SQLite access. Dynoxide embedded scales better because each test gets its own isolated `Database::memory()` with no shared state.
...
| Operation | Latency |
|-----------|---------|
| GetItem | <!-- bench:ci_criterion_get_item -->14µs<!-- /bench --> |
| PutItem (small / medium / large) | <!-- bench:ci_criterion_put_item_small -->21µs<!-- /bench --> / <!-- bench:ci_criterion_put_item_medium -->37µs<!-- /bench --> / <!-- bench:ci_criterion_put_item_large -->272µs<!-- /bench --> |
| Query (base, ~50 hits) | <!-- bench:ci_criterion_query_base -->1.2ms<!-- /bench --> |
| Query (GSI) | <!-- bench:ci_criterion_query_gsi -->22µs<!-- /bench --> |
| Scan (filter, 1K items) | <!-- bench:ci_criterion_scan -->9.1ms<!-- /bench --> |
| UpdateItem | <!-- bench:ci_criterion_update_item -->170µs<!-- /bench --> |
| DeleteItem | <!-- bench:ci_criterion_delete_item -->46µs<!-- /bench --> |
| BatchWrite (25) | <!-- bench:ci_criterion_batch_write -->958µs<!-- /bench --> |
| BatchGet (100) | <!-- bench:ci_criterion_batch_get -->1.4ms<!-- /bench --> |
| TransactWrite (4) | <!-- bench:ci_criterion_transact_write -->224µs<!-- /bench --> |
...
|--------|-----------|-------------|------------------------|---------------------|
| Idle | <!-- bench:ci_mem_memory_idle -->5.0 MB<!-- /bench --> RSS | <!-- bench:ci_mem_file_idle -->41.2 MB<!-- /bench --> RSS | <!-- bench:ci_mem_ddb_local_idle -->193.3 MB<!-- /bench --> RSS | <!-- bench:ci_mem_localstack_idle -->510.0 MB<!-- /bench --> RSS |
| After 10K items (~1KB each) | <!-- bench:ci_mem_memory_loaded -->46.0 MB<!-- /bench --> RSS | <!-- bench:ci_mem_file_loaded -->41.2 MB<!-- /bench --> RSS | — | — |
