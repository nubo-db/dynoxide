...
Results from `ubuntu-latest` (2-core AMD EPYC 7763, 8GB RAM). Commit <!-- bench:ci_commit_link_benchmarks -->[`7d5fd8a`](../../../commit/7d5fd8afa53b30e5f138f786399565389c998623)<!-- /bench -->. Absolute wall-clock numbers vary between runners; ratios are stable across runs.

### Cold Startup

| Target | Mean | Stddev | vs DynamoDB Local |
|--------|------|--------|-------------------|
| Dynoxide Embedded | <!-- bench:ci_startup_embedded_mean -->0.3ms<!-- /bench --> | <!-- bench:ci_startup_embedded_stddev -->±0.1ms<!-- /bench --> | <!-- bench:ci_startup_embedded_ratio -->**~11,572x faster**<!-- /bench --> |
| Dynoxide HTTP | <!-- bench:ci_startup_http_mean -->2.1ms<!-- /bench --> | <!-- bench:ci_startup_http_stddev -->±2.5ms<!-- /bench --> | <!-- bench:ci_startup_http_ratio -->**~1,435x faster**<!-- /bench --> |
| DynamoDB Local | <!-- bench:ci_startup_ddb_local_mean -->3,012ms<!-- /bench --> | <!-- bench:ci_startup_ddb_local_stddev -->±236ms<!-- /bench --> | — |
| LocalStack | <!-- bench:ci_startup_localstack_mean -->12,434ms<!-- /bench --> | <!-- bench:ci_startup_localstack_stddev -->±771ms<!-- /bench --> | <!-- bench:ci_startup_localstack_ratio -->4.1x slower<!-- /bench --> |
...
| Operation | Dynoxide HTTP (p50) | DynamoDB Local (p50) | Speedup |
|-----------|-------------------|---------------------|---------|
| CreateTable | <!-- bench:ci_op_CreateTable_http -->0.68ms<!-- /bench --> | <!-- bench:ci_op_CreateTable_ddb -->27.5ms<!-- /bench --> | <!-- bench:ci_op_CreateTable_ratio -->**41x**<!-- /bench --> |
| GetItem | <!-- bench:ci_op_GetItem_http -->0.33ms<!-- /bench --> | <!-- bench:ci_op_GetItem_ddb -->0.84ms<!-- /bench --> | <!-- bench:ci_op_GetItem_ratio -->**2.5x**<!-- /bench --> |
| PutItem | <!-- bench:ci_op_PutItem_http -->0.41ms<!-- /bench --> | <!-- bench:ci_op_PutItem_ddb -->1.0ms<!-- /bench --> | <!-- bench:ci_op_PutItem_ratio -->**2.5x**<!-- /bench --> |
| Query (base) | <!-- bench:ci_op_Query_http -->0.36ms<!-- /bench --> | <!-- bench:ci_op_Query_ddb -->1.6ms<!-- /bench --> | <!-- bench:ci_op_Query_ratio -->**4.5x**<!-- /bench --> |
| Query (GSI) | <!-- bench:ci_op_QueryGSI_http -->0.36ms<!-- /bench --> | <!-- bench:ci_op_QueryGSI_ddb -->1.3ms<!-- /bench --> | <!-- bench:ci_op_QueryGSI_ratio -->**3.5x**<!-- /bench --> |
| Query (paginated) | <!-- bench:ci_op_QueryPaginated_http -->2.8ms<!-- /bench --> | <!-- bench:ci_op_QueryPaginated_ddb -->7.6ms<!-- /bench --> | <!-- bench:ci_op_QueryPaginated_ratio -->**2.7x**<!-- /bench --> |
| Scan (full table) | <!-- bench:ci_op_Scan_http -->73.1ms<!-- /bench --> | <!-- bench:ci_op_Scan_ddb -->253.7ms<!-- /bench --> | <!-- bench:ci_op_Scan_ratio -->**3.5x**<!-- /bench --> |
| UpdateItem | <!-- bench:ci_op_UpdateItem_http -->0.44ms<!-- /bench --> | <!-- bench:ci_op_UpdateItem_ddb -->1.5ms<!-- /bench --> | <!-- bench:ci_op_UpdateItem_ratio -->**3.3x**<!-- /bench --> |
| TransactWriteItems | <!-- bench:ci_op_TransactWriteItems_http -->0.72ms<!-- /bench --> | <!-- bench:ci_op_TransactWriteItems_ddb -->6.3ms<!-- /bench --> | <!-- bench:ci_op_TransactWriteItems_ratio -->**8.7x**<!-- /bench --> |
| BatchGetItem (100 keys) | <!-- bench:ci_op_BatchGetItem_http -->3.3ms<!-- /bench --> | <!-- bench:ci_op_BatchGetItem_ddb -->13.4ms<!-- /bench --> | <!-- bench:ci_op_BatchGetItem_ratio -->**4.1x**<!-- /bench --> |
| BatchWriteItem (25 items) | <!-- bench:ci_op_BatchWriteItem_http -->2.5ms<!-- /bench --> | <!-- bench:ci_op_BatchWriteItem_ddb -->9.7ms<!-- /bench --> | <!-- bench:ci_op_BatchWriteItem_ratio -->**3.9x**<!-- /bench --> |
| DeleteItem | <!-- bench:ci_op_DeleteItem_http -->0.35ms<!-- /bench --> | <!-- bench:ci_op_DeleteItem_ddb -->1.0ms<!-- /bench --> | <!-- bench:ci_op_DeleteItem_ratio -->**2.9x**<!-- /bench --> |
| **Total workload** | <!-- bench:ci_workload_http -->**3.1s**<!-- /bench --> | <!-- bench:ci_workload_ddb -->**12.4s**<!-- /bench --> | <!-- bench:ci_workload_ratio -->**4.0x**<!-- /bench --> |
...
| Mode | Wall Clock | Speedup vs DDB Local |
|------|-----------|---------------------|
| Dynoxide Embedded (sequential) | <!-- bench:ci_suite_embedded_seq -->793ms<!-- /bench --> | <!-- bench:ci_suite_embedded_seq_ratio -->**3.5x**<!-- /bench --> |
| Dynoxide Embedded (4x parallel) | <!-- bench:ci_suite_embedded_par -->398ms<!-- /bench --> | <!-- bench:ci_suite_embedded_par_ratio -->**6.7x**<!-- /bench --> |
| Dynoxide HTTP (sequential) | <!-- bench:ci_suite_http_seq -->772ms<!-- /bench --> | <!-- bench:ci_suite_http_seq_ratio -->**3.6x**<!-- /bench --> |
| Dynoxide HTTP (4x parallel) | <!-- bench:ci_suite_http_par -->479ms<!-- /bench --> | <!-- bench:ci_suite_http_par_ratio -->**5.5x**<!-- /bench --> |
| DynamoDB Local (sequential) | <!-- bench:ci_suite_ddb_seq -->2,807ms<!-- /bench --> | — |
| DynamoDB Local (4x parallel) | <!-- bench:ci_suite_ddb_par -->2,652ms<!-- /bench --> | — |

DynamoDB Local barely benefits from parallelism (<!-- bench:ci_suite_ddb_seq_prose -->2,807ms<!-- /bench --> → <!-- bench:ci_suite_ddb_par_prose -->2,652ms<!-- /bench -->). Under concurrent load, individual tests take 3-4x longer due to JVM contention — setup times spike to 200-1,000ms on some tests as `CreateTable` calls queue behind the JVM's single-threaded SQLite access. Dynoxide embedded scales better because each test gets its own isolated `Database::memory()` with no shared state.
...
| PutItem (small / medium / large) | <!-- bench:ci_criterion_put_item_small -->27µs<!-- /bench --> / <!-- bench:ci_criterion_put_item_medium -->47µs<!-- /bench --> / <!-- bench:ci_criterion_put_item_large -->265µs<!-- /bench --> |
...
| UpdateItem | <!-- bench:ci_criterion_update_item -->185µs<!-- /bench --> |
...
| TransactWrite (4) | <!-- bench:ci_criterion_transact_write -->268µs<!-- /bench --> |
...
|--------|-----------|-------------|------------------------|---------------------|
| Idle | <!-- bench:ci_mem_memory_idle -->5.0 MB<!-- /bench --> RSS | <!-- bench:ci_mem_file_idle -->45.5 MB<!-- /bench --> RSS | <!-- bench:ci_mem_ddb_local_idle -->175.6 MB<!-- /bench --> RSS | <!-- bench:ci_mem_localstack_idle -->506.7 MB<!-- /bench --> RSS |
| After 10K items (~1KB each) | <!-- bench:ci_mem_memory_loaded -->45.8 MB<!-- /bench --> RSS | <!-- bench:ci_mem_file_loaded -->45.5 MB<!-- /bench --> RSS | — | — |
