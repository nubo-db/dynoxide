...
Results from `ubuntu-latest` (<!-- prose:ci_runner_hardware -->4-core Intel(R) Xeon(R) 6973P-C, 16GB RAM<!-- /bench -->). Commit <!-- bench:ci_commit_link_benchmarks -->[`49c6338`](../../../commit/49c6338adf3ea2efea9991033183ffaaefe1b08a)<!-- /bench -->. Absolute wall-clock numbers vary between runners; ratios are stable across runs.

### Cold Startup

| Target | Mean | Stddev | vs DynamoDB Local |
|--------|------|--------|-------------------|
| Dynoxide Embedded | <!-- bench:ci_startup_embedded_mean -->0.2ms<!-- /bench --> | <!-- bench:ci_startup_embedded_stddev -->±0.2ms<!-- /bench --> | <!-- bench:ci_startup_embedded_ratio -->**~11,820x faster**<!-- /bench --> |
| Dynoxide HTTP | <!-- bench:ci_startup_http_mean -->1.6ms<!-- /bench --> | <!-- bench:ci_startup_http_stddev -->±1.6ms<!-- /bench --> | <!-- bench:ci_startup_http_ratio -->**~1,730x faster**<!-- /bench --> |
| DynamoDB Local | <!-- bench:ci_startup_ddb_local_mean -->2,831ms<!-- /bench --> | <!-- bench:ci_startup_ddb_local_stddev -->±477ms<!-- /bench --> | — |
| LocalStack | <!-- bench:ci_startup_localstack_mean -->13,473ms<!-- /bench --> | <!-- bench:ci_startup_localstack_stddev -->±2,138ms<!-- /bench --> | <!-- bench:ci_startup_localstack_ratio -->4.8x slower<!-- /bench --> |
...
| Operation | Dynoxide HTTP (p50) | DynamoDB Local (p50) | Speedup |
|-----------|-------------------|---------------------|---------|
| CreateTable | <!-- bench:ci_op_CreateTable_http -->0.56ms<!-- /bench --> | <!-- bench:ci_op_CreateTable_ddb -->19.5ms<!-- /bench --> | <!-- bench:ci_op_CreateTable_ratio -->**35x**<!-- /bench --> |
| GetItem | <!-- bench:ci_op_GetItem_http -->0.25ms<!-- /bench --> | <!-- bench:ci_op_GetItem_ddb -->0.69ms<!-- /bench --> | <!-- bench:ci_op_GetItem_ratio -->**2.8x**<!-- /bench --> |
| PutItem | <!-- bench:ci_op_PutItem_http -->0.33ms<!-- /bench --> | <!-- bench:ci_op_PutItem_ddb -->0.82ms<!-- /bench --> | <!-- bench:ci_op_PutItem_ratio -->**2.5x**<!-- /bench --> |
| Query (base) | <!-- bench:ci_op_Query_http -->0.27ms<!-- /bench --> | <!-- bench:ci_op_Query_ddb -->1.2ms<!-- /bench --> | <!-- bench:ci_op_Query_ratio -->**4.3x**<!-- /bench --> |
| Query (GSI) | <!-- bench:ci_op_QueryGSI_http -->0.30ms<!-- /bench --> | <!-- bench:ci_op_QueryGSI_ddb -->0.89ms<!-- /bench --> | <!-- bench:ci_op_QueryGSI_ratio -->**2.9x**<!-- /bench --> |
| Query (paginated) | <!-- bench:ci_op_QueryPaginated_http -->2.1ms<!-- /bench --> | <!-- bench:ci_op_QueryPaginated_ddb -->4.8ms<!-- /bench --> | <!-- bench:ci_op_QueryPaginated_ratio -->**2.3x**<!-- /bench --> |
| Scan (full table) | <!-- bench:ci_op_Scan_http -->50.2ms<!-- /bench --> | <!-- bench:ci_op_Scan_ddb -->170.1ms<!-- /bench --> | <!-- bench:ci_op_Scan_ratio -->**3.4x**<!-- /bench --> |
| UpdateItem | <!-- bench:ci_op_UpdateItem_http -->0.25ms<!-- /bench --> | <!-- bench:ci_op_UpdateItem_ddb -->1.3ms<!-- /bench --> | <!-- bench:ci_op_UpdateItem_ratio -->**5.2x**<!-- /bench --> |
| TransactWriteItems | <!-- bench:ci_op_TransactWriteItems_http -->0.64ms<!-- /bench --> | <!-- bench:ci_op_TransactWriteItems_ddb -->4.0ms<!-- /bench --> | <!-- bench:ci_op_TransactWriteItems_ratio -->**6.3x**<!-- /bench --> |
| BatchGetItem (100 keys) | <!-- bench:ci_op_BatchGetItem_http -->2.2ms<!-- /bench --> | <!-- bench:ci_op_BatchGetItem_ddb -->8.1ms<!-- /bench --> | <!-- bench:ci_op_BatchGetItem_ratio -->**3.7x**<!-- /bench --> |
| BatchWriteItem (25 items) | <!-- bench:ci_op_BatchWriteItem_http -->1.5ms<!-- /bench --> | <!-- bench:ci_op_BatchWriteItem_ddb -->5.7ms<!-- /bench --> | <!-- bench:ci_op_BatchWriteItem_ratio -->**3.9x**<!-- /bench --> |
| DeleteItem | <!-- bench:ci_op_DeleteItem_http -->0.28ms<!-- /bench --> | <!-- bench:ci_op_DeleteItem_ddb -->0.74ms<!-- /bench --> | <!-- bench:ci_op_DeleteItem_ratio -->**2.7x**<!-- /bench --> |
| **Total workload** | <!-- bench:ci_workload_http -->**2.1s**<!-- /bench --> | <!-- bench:ci_workload_ddb -->**8.2s**<!-- /bench --> | <!-- bench:ci_workload_ratio -->**4.0x**<!-- /bench --> |
...
| Mode | Wall Clock | Speedup vs DDB Local |
|------|-----------|---------------------|
| Dynoxide Embedded (sequential) | <!-- bench:ci_suite_embedded_seq -->573ms<!-- /bench --> | <!-- bench:ci_suite_embedded_seq_ratio -->**3.3x**<!-- /bench --> |
| Dynoxide Embedded (4x parallel) | <!-- bench:ci_suite_embedded_par -->254ms<!-- /bench --> | <!-- bench:ci_suite_embedded_par_ratio -->**4.7x**<!-- /bench --> |
| Dynoxide HTTP (sequential) | <!-- bench:ci_suite_http_seq -->533ms<!-- /bench --> | <!-- bench:ci_suite_http_seq_ratio -->**3.5x**<!-- /bench --> |
| Dynoxide HTTP (4x parallel) | <!-- bench:ci_suite_http_par -->326ms<!-- /bench --> | <!-- bench:ci_suite_http_par_ratio -->**3.7x**<!-- /bench --> |
| DynamoDB Local (sequential) | <!-- bench:ci_suite_ddb_seq -->1,871ms<!-- /bench --> | — |
| DynamoDB Local (4x parallel) | <!-- bench:ci_suite_ddb_par -->1,202ms<!-- /bench --> | — |

DynamoDB Local barely benefits from parallelism (<!-- bench:ci_suite_ddb_seq_prose -->1,871ms<!-- /bench --> → <!-- bench:ci_suite_ddb_par_prose -->1,202ms<!-- /bench -->). Under concurrent load, individual tests take 3-4x longer due to JVM contention — setup times spike to 200-1,000ms on some tests as `CreateTable` calls queue behind the JVM's single-threaded SQLite access. Dynoxide embedded scales better because each test gets its own isolated `Database::memory()` with no shared state.
...
| Operation | Latency |
|-----------|---------|
| GetItem | <!-- bench:ci_criterion_get_item -->10µs<!-- /bench --> |
| PutItem (small / medium / large) | <!-- bench:ci_criterion_put_item_small -->13µs<!-- /bench --> / <!-- bench:ci_criterion_put_item_medium -->25µs<!-- /bench --> / <!-- bench:ci_criterion_put_item_large -->145µs<!-- /bench --> |
| Query (base, ~50 hits) | <!-- bench:ci_criterion_query_base -->821µs<!-- /bench --> |
| Query (GSI) | <!-- bench:ci_criterion_query_gsi -->15µs<!-- /bench --> |
| Scan (filter, 1K items) | <!-- bench:ci_criterion_scan -->6.1ms<!-- /bench --> |
| UpdateItem | <!-- bench:ci_criterion_update_item -->152µs<!-- /bench --> |
| DeleteItem | <!-- bench:ci_criterion_delete_item -->33µs<!-- /bench --> |
| BatchWrite (25) | <!-- bench:ci_criterion_batch_write -->675µs<!-- /bench --> |
| BatchGet (100) | <!-- bench:ci_criterion_batch_get -->949µs<!-- /bench --> |
| TransactWrite (4) | <!-- bench:ci_criterion_transact_write -->157µs<!-- /bench --> |
...
|--------|-----------|-------------|------------------------|---------------------|
| Idle | <!-- bench:ci_mem_memory_idle -->5.3 MB<!-- /bench --> RSS | <!-- bench:ci_mem_file_idle -->46.0 MB<!-- /bench --> RSS | <!-- bench:ci_mem_ddb_local_idle -->204.8 MB<!-- /bench --> RSS | <!-- bench:ci_mem_localstack_idle -->388.0 MB<!-- /bench --> RSS |
| After 10K items (~1KB each) | <!-- bench:ci_mem_memory_loaded -->46.0 MB<!-- /bench --> RSS | <!-- bench:ci_mem_file_loaded -->46.0 MB<!-- /bench --> RSS | — | — |
