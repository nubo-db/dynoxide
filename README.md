...
I built Dynoxide because DynamoDB Local is slow, heavy, and can't embed. It needs a JVM, and the typical Docker-based setups adds <!-- prose:ddb_local_cold_start -->~3 seconds<!-- /bench --> of cold-start, <!-- prose:ddb_local_idle_memory -->~173 MB<!-- /bench --> of memory at idle, and a <!-- prose:ddb_local_image_size -->~225MB<!-- /bench --> Docker image (<!-- prose:ddb_local_image_size_disk -->~471 MB<!-- /bench --> on disk) before you've done anything useful. If you're running integration tests, that's Docker starting, the JVM warming up, and your pipeline waiting.

Dynoxide is a native binary. It starts in milliseconds, idles at <!-- prose:dynoxide_idle_memory -->~4.8 MB<!-- /bench -->, and ships as a <!-- prose:dynoxide_binary_size -->~3 MB<!-- /bench --> download. Point any DynamoDB SDK at it and your tests just work.
...
Numbers from `ubuntu-latest` (2-core AMD EPYC 7763, 8GB RAM). Commit <!-- bench:ci_commit_link_root -->[`36a7a8d`](../../commit/36a7a8d17f9c1fc41053d9b55ffb84ac10b498f1)<!-- /bench -->.

| Metric | Dynoxide (embedded) | Dynoxide (HTTP) | DynamoDB Local | LocalStack (all services) |
|---|---|---|---|---|
| Cold startup | <!-- bench:ci_startup_embedded -->**<1ms**<!-- /bench --> | <!-- bench:ci_startup_http -->**~2ms**<!-- /bench --> | <!-- bench:ci_startup_ddb_local -->~2,977ms<!-- /bench --> | <!-- bench:ci_startup_localstack -->~12,444ms<!-- /bench --> |
...
| 50-test CI suite | <!-- bench:ci_suite_embedded_seq -->802ms<!-- /bench --> | <!-- bench:ci_suite_http_seq -->776ms<!-- /bench --> | <!-- bench:ci_suite_ddb_local_seq -->2,635ms<!-- /bench --> | - |
| Full workload (10K items) | - | <!-- bench:ci_workload_http -->**3.1s**<!-- /bench --> | <!-- bench:ci_workload_ddb_local -->12.0s<!-- /bench --> | - |
...
| Binary / image (on disk) | <!-- bench:ci_binary_size -->7 MB<!-- /bench --> | <!-- bench:ci_binary_size_http -->7 MB<!-- /bench --> | <!-- bench:ci_image_ddb_local -->471 MB<!-- /bench --> | <!-- bench:ci_image_localstack -->1.1 GB<!-- /bench --> |
| Idle memory (RSS) | <!-- bench:ci_memory_embedded_idle -->~4.8 MB<!-- /bench --> | <!-- bench:ci_memory_http_idle -->~8 MB<!-- /bench --> | <!-- bench:ci_memory_ddb_local_idle -->~173 MB<!-- /bench --> | <!-- bench:ci_memory_localstack_idle -->~498 MB<!-- /bench --> |
